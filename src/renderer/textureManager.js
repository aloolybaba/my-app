...
const REQUIRED_ASSETS = [
  ...
  path.join(TEXTURE_DIR, 'redstone_lamp.png'),
  path.join(TEXTURE_DIR, 'redstone_lamp_on.png'),
  ...
  path.join(BLOCKSTATE_DIR, 'redstone_lamp.json'),
  ...
  path.join(MODEL_DIR, 'redstone_lamp.json'),
  path.join(MODEL_DIR, 'redstone_lamp_on.json'),
